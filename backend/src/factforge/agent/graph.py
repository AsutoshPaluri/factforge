"""LangGraph wiring: decompose -> retrieve -> nli -> synthesize.

The graph is linear for v1. Future stages (Langfuse callbacks, conditional
edges for image-only claims, parallel sub-claim branches) layer on top
without changing the node implementations.
